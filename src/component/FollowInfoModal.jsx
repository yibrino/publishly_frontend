...
export const FollowInfoModal = ({
  currentUser,
  followersInfoModal,
  showFollowing,
  setFollowersInfoModal,
}) => {
  return (
    <Modal
      styles={{
      ...
      {showFollowing ? (
        <div className="flex flex-col">
          ...
          {!currentUser?.following.length ? (
            <h3 className="text-center text-slate-800 mt-2">
        ...
        <div className="flex flex-col">
          ...
          {!currentUser?.followers.length ? (
            <h3 className="text-center text-slate-800 mt-2">No followers</h3>
          ) : (
